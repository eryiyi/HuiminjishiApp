...
import com.lbins.hmjs.data.ShoppingAddressSingleDATA;
...
//                    liner_wuliu.setVisibility(View.GONE);
            ...
            imageLoader.displayImage((orderVo.getEmpCover()==null?"":orderVo.getEmpCover()), item_head, MeetLoveApplication.txOptions, animateFirstListener);
            imageLoader.displayImage((orderVo.getGoodsCover()==null?"":orderVo.getGoodsCover()), item_pic, MeetLoveApplication.txOptions, animateFirstListener);
