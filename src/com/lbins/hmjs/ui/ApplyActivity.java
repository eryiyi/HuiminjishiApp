...
import com.lbins.hmjs.widget.SelectPhoPopWindow;
    ...
    public void upDianpu(){
        StringRequest request = new StringRequest(
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                if(checkbox.isChecked() && !StringUtil.isNullOrEmpty(MeetLoveApplication.latStr) && !StringUtil.isNullOrEmpty(MeetLoveApplication.lngStr)){
