...
import com.lbins.hmjs.data.BankObjData;
import com.lbins.hmjs.data.CountData;
import com.lbins.hmjs.data.MinePackageData;
import com.lbins.hmjs.module.Count;
import com.lbins.hmjs.module.MinePackage;
...
public class MinePackageActivity extends BaseActivity implements View.OnClickListener {
    ...
    void initData(){
        if(!StringUtil.isNullOrEmpty(getGson().fromJson(getSp().getString("empCover", ""), String.class))){
            imageLoader.displayImage(getGson().fromJson(getSp().getString("empCover", ""), String.class), cover, MeetLoveApplication.txOptions, animateFirstListener);
        }
