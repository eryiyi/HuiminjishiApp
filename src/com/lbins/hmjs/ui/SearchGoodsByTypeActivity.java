...
import com.lbins.hmjs.adapter.GoodsTypeAdapter;
...
public class SearchGoodsByTypeActivity extends BaseActivity implements View.OnClickListener {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                if(tmpNearby == 1){
                    if(!StringUtil.isNullOrEmpty(MeetLoveApplication.latStr)){
                        params.put("lat_company", MeetLoveApplication.latStr);
                    }
                    if(!StringUtil.isNullOrEmpty(MeetLoveApplication.lngStr)){
                        params.put("lng_company", MeetLoveApplication.lngStr);
                    }
                }
    ...
    private void showGoodsType() {
        ...
        GoodsTypeAdapter adapter = new GoodsTypeAdapter(MainActivity.listGoodsType, SearchGoodsByTypeActivity.this);
        listView.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                GoodsType goodsType = MainActivity.listGoodsType.get(i);
