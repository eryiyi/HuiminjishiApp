...
import com.lbins.hmjs.data.MinePackageData;
import com.lbins.hmjs.data.OrderInfoAndSignDATA;
import com.lbins.hmjs.data.SuccessData;
import com.lbins.hmjs.data.WxPayObjData;
import com.lbins.hmjs.module.*;
import com.lbins.hmjs.pay.OrderInfoAndSign;
import com.lbins.hmjs.pay.PayResult;
import com.lbins.hmjs.util.StringUtil;
import com.lbins.hmjs.wxpay.MD5;
import com.lbins.hmjs.wxpay.Util;
...
//            payable_amount = doublePricesAll*((Double.parseDouble(getGson().fromJson(getSp().getString("level_zhe", ""), String.class)) * 0.1));
            payable_amount = doublePricesAll;
                            ...
                            if(shoppingAddress != null){
                                for(int i=0;i<lists.size();i++){
                                    ...
                                    if(shoppingCart!=null && shoppingCart.getIs_select().equals("0")){
                                        ...
                                        Double payable_amount = payable_amount_all;
