...
import com.lbins.hmjs.adapter.Publish_mood_GridView_Adapter;
import com.lbins.hmjs.base.BaseActivity;
import com.lbins.hmjs.base.InternetURL;
import com.lbins.hmjs.util.CommonDefine;
import com.lbins.hmjs.util.FileUtils;
import com.lbins.hmjs.util.ImageUtils;
...
//            }
    ...
    public void showQuitePop(){
        selectPopQuiteWindow = new SelectPopQuiteWindow(PublishRecordActivity.this, itemsOnClickQuite);
        //显示窗口
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_right:
                uploadPaths.clear();
                if (dataList.size() == 0 && StringUtil.isNullOrEmpty(content.getText().toString())) {
                    showMsg(PublishRecordActivity.this, "请输入内容或选择图片！");
                    return;
                }
                progressDialog = new CustomProgressDialog(PublishRecordActivity.this, "请稍后...",R.anim.custom_dialog_frame);
        ...
        StringRequest request = new StringRequest(
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (code1 == 200) {
                                    Toast.makeText(PublishRecordActivity.this, "发布动态成功！", Toast.LENGTH_SHORT).show();
                                    //调用广播，刷新主页
                                    Intent intent1 = new Intent("add_record_success");
                                    sendBroadcast(intent1);
                                    finish();
                                } else {
                                    Toast.makeText(PublishRecordActivity.this, jo.getString("message"), Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(PublishRecordActivity.this, "添加数据失败，请稍后重试！", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
            protected Map<String, String> getParams() {
                ...
                if(!StringUtil.isNullOrEmpty(String.valueOf(filePath))){
                    params.put("record_pic", String.valueOf(filePath));
                    params.put("record_type", "2");
                }else{
                    params.put("record_type", "1");
                }
                params.put("record_cont", content.getText().toString());
    ...
    public void showSelectImageDialog(){
        selectPhotoPopWindow = new SelectPhotoPopWindow(PublishRecordActivity.this, itemsOnClick);
        //显示窗口
        setBackgroundAlpha(0.5f);//设置屏幕透明度
    ...
    public void setBackgroundAlpha(float bgAlpha) {
        WindowManager.LayoutParams lp = ((Activity) PublishRecordActivity.this).getWindow()
                .getAttributes();
        lp.alpha = bgAlpha;
        ((Activity) PublishRecordActivity.this).getWindow().setAttributes(lp);
    }
