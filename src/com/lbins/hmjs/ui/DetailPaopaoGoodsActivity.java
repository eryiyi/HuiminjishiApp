...
import com.lbins.hmjs.adapter.GoodsDetailViewPagerAdapter;
import com.lbins.hmjs.adapter.ItemCommentAdapter;
...
import com.lbins.hmjs.data.*;
import com.lbins.hmjs.dao.DBHelper;
import com.lbins.hmjs.module.*;
import com.lbins.hmjs.util.DateUtil;
import com.lbins.hmjs.util.StringUtil;
import com.lbins.hmjs.widget.ContentListView;
import com.lbins.hmjs.widget.MenuPopMenu;
import com.lbins.hmjs.widget.TelPopWindow;
...
//        }
    ...
    void initData(){
        if(managerInfo != null){
            ...
            if(!StringUtil.isNullOrEmpty(MeetLoveApplication.latStr) && !StringUtil.isNullOrEmpty(MeetLoveApplication.lngStr) && !StringUtil.isNullOrEmpty(managerInfo.getLat_company())&& !StringUtil.isNullOrEmpty(managerInfo.getLng_company()) ){
            ...
            if(!StringUtil.isNullOrEmpty(managerInfo.getCompany_pic())){
                imageLoader.displayImage(managerInfo.getCompany_pic(), dianpu_cover, MeetLoveApplication.options, animateFirstListener);
            }
        }else {
