...
public class ItemMineOrderAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (cell != null) {
            imageLoader.displayImage(cell.getEmpCover(), holder.item_head, MeetLoveApplication.txOptions, animateFirstListener);
            imageLoader.displayImage(cell.getGoodsCover(), holder.item_pic, MeetLoveApplication.txOptions, animateFirstListener);
