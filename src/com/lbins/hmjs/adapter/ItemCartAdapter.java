...
public class ItemCartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (findEmps != null) {
            imageLoader.displayImage(arrs[0], holder.item_cart_pic, MeetLoveApplication.txOptions, animateFirstListener);
            imageLoader.displayImage(favour.getEmp_cover(), holder.item_cart_cover, MeetLoveApplication.txOptions, animateFirstListener);
