...
import com.lbins.hmjs.module.PaihangDianpu;
...
public class ItemTopDianpusAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (cell != null) {
            imageLoader.displayImage(cell.getCompany_pic(), holder.cover, MeetLoveApplication.options, animateFirstListener);
            holder.name.setText(cell.getCompany_name());
            holder.typename.setText(cell.getType_name());
            if(!StringUtil.isNullOrEmpty(MeetLoveApplication.latStr) && !StringUtil.isNullOrEmpty(MeetLoveApplication.lngStr) && !StringUtil.isNullOrEmpty(cell.getLat_company())&& !StringUtil.isNullOrEmpty(cell.getLng_company()) ){
